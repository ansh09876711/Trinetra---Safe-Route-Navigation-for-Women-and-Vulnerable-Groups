    ...
    <div className="landing-root" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <Logo height={40} />
          <h2 className="gradient-text" style={{ marginTop: '24px', fontSize: '28px' }}>Create Account</h2>
          <p style={{ color: 'var(--text3)', fontSize: '14px', marginTop: '8px' }}>Join TRINETRA for your safety</p>
        </div>
        ...
        <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <label style={{ fontSize: '13px', color: 'var(--text2)', marginLeft: '4px' }}>Full Name</label>
            <input
              type="text"
              required
        ...
        <p style={{ textAlign: 'center', marginTop: '24px', fontSize: '14px', color: 'var(--text3)' }}>
          Already have an account? <Link to="/login" style={{ color: 'var(--accent)', fontWeight: '600', textDecoration: 'none' }}>Login here</Link>
        </p>
      </div>
    </div>
  );
